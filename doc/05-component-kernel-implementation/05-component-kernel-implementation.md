...
I am going to use Track[] to represent my playlist because then I can manipulate the tracks easily by having a subclass and accessing them in an array. This requires a track limit, but I think that is acceptable and reasonable for a playlist.
