...
I am going to go with the playlist design. I am going with this design because
it seems to offer the best combination of kernel and secondary methods. I also
feel confident in my ability to implement this design and it is the most similar
to an "end product" that I would actually use.
